...
void gameTemp::Application::configureOpenGL() {
...
gameTemp::WindowConfiguration gameTemp::Application::getWindowConfiguration() {
...
void gameTemp::Application::setupCallbacks() {
